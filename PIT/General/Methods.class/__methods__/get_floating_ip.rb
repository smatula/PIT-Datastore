#
# Description: Obtain Free Floating IP/IPS for given
#      Tenant and network.
#      Will look for free existing Floating IPS.
#      If found will return them in list.
#      If not found will create.
# Cloud tenant (ID) required = 2017000000000001
# Cloud network(ID) required = 2017000000000002
# 
